...
export default function Contact({className, bg, text, label, number1, number2}) {
  return(
    <div style={{ boxShadow: "0px 10px 20px 2px rgba(0, 0, 0, 0.25)" }} className={`${bg} ${text} ${className} w-[300px] text-2xl p-8 flex flex-col items-center justify-center rounded-xl`}>
